...
@section('admin-content')
    ...
    <h3 class="my-5">
        Criteria Rewards
        <button class="btn btn-primary float-right add-calc" type="button" aria-label="add criterion">+ Criterion</a></button>
    </h3>
    <p>
        Criteria can be used in addition to or in replacment of rewards. They can be created under the "criterion" section
        of the admin panel,
        and allow for dynamic reward amounts to be generated based on user / admin selected criteria like the type of art,
